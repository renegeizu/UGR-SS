...
bool parar, tormenta;
float reloj, tdus_at, tdus_lleg, tdus_rem, tdus_sal;
...
float acum_estancia[3], acum_lleg, acum_rem_amarrado, acum_rem_viajando, acum_rem_remolcando, acum_sal;
float acum_at_cargando, acum_at_desocupado, acum_at_yacargado, **informe;
int cont_simu, num_barcos[3];

float frec1 = 0.25, frec2 = 0.25, frec3 = 0.50, tiempo_carga1min = 16.0, tiempo_carga2min = 21.0;
float tiempo_carga3min = 32.0, tiempo_carga1max = 20.0, tiempo_carga2max = 27.0, tiempo_carga3max = 40.0;
float tllegmax = 18.0, tllegmin = 4.0, tparada = 8760.0, tviajellenomax = 1.25, tviajellenomin = 0.75, tviajevacio = 0.15;
